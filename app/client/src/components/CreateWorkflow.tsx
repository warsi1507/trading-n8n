        ...
        <div className="flex flex-col gap-1 w-full max-w-[800px] pointer-events-auto bg-background/60 backdrop-blur-xl p-3 px-4 rounded-xl border border-border/50 shadow-sm transition-all">
          {isEditingName ? (
            ...
            <h1
              ...
              className="text-lg font-semibold cursor-text hover:text-primary transition-colors text-foreground px-1 -ml-1 truncate"
            >
              {workflowName}
            </h1>
          )}
          ...
          {isEditingDescription ? (
            ...
            <p
              ...
              className="text-xs text-muted-foreground cursor-text hover:text-foreground transition-colors line-clamp-2 px-1 -ml-1 mt-0.5"
            >
              {workflowDescription}
            </p>
          )}
                ...
                nds.map((n) =>
                  n.id === triggerSheetState.editNode!.id
                    ? {
                        ...n,
                        type,
                        data: { ...n.data, name, description, metadata },
                      }
                    : n,
                ),
              );
