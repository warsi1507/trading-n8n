  ...
  useEffect(() => {
    ...
    for (let x = -3000; x <= 3000; x += step) {
      for (let y = -3000; y <= 3000; y += step) {
        ...
        let dist = Math.sqrt(
          Math.pow(screenX - 150, 2) + Math.pow(screenY - 400, 2),
        );
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center -z-10 md:z-0">
      <svg
        ...
        className="w-[180%] lg:w-[220%] max-w-none h-auto translate-x-6 md:translate-x-12 -translate-y-11 md:-translate-y-22 overflow-visible origin-center"
      >
        <defs>
          ...
          <rect
            ...
            height="100"
            rx="24"
            transform="scale(1, 0.6) rotate(-45)"
          />
          ...
          <g id="tile-blue">
            ...
            <g transform="scale(1, 0.6) rotate(-45)">
              <path
                fill="white"
                d="M 6 -18 L -12 2 L -2 2 L -6 18 L 12 -2 L 2 -2 Z"
              />
            </g>
          </g>
          ...
          <path
            id="cord2"
            d="M 385 270 C 370 225, 340 170, 365 145 C 385 125, 420 105, 445 95"
          />
          <path
            id="cord3"
            d="M 345 265 C 400 270, 455 265, 515 290 C 580 305, 600 270, 700 210"
          />
        </defs>
        ...
        <g>
          ...
          >
            ...
            <use
              href="#cord1"
              stroke="url(#cord-gradient-green-blue)"
              strokeWidth="5"
              strokeLinecap="round"
            />
            <use
          ...
          <g className="animate-graphic-in" style={{ animationDelay: "600ms" }}>
            <use
              href="#tile-green"
              transform="translate(150, 400) scale(1.0)"
            />
          </g>
