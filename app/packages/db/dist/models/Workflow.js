...
}, { _id: false }); // Disable mongoose from generating object ids for embedded nodes
...
}, { _id: false }); // Disable object ids for embedded edges
...
const workflowSchema = new Schema({
    ...
    status: { type: String, enum: ["DRAFT", "DEPLOYED", "IN_EDIT"], required: true, default: "DRAFT" },
